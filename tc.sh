...
contrib/hack/kubectl config set-cluster service-catalog-cluster --server=https://localhost:6443 --certificate-authority=$(pwd)/.apiserver.crt
...
go build -v -i  client.go
./client  -v 10 -stderrthreshold 10 -logtostderr
