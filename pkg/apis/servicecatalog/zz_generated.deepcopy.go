...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_servicecatalog_Plan, InType: reflect.TypeOf(&Plan{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_servicecatalog_PlanList, InType: reflect.TypeOf(&PlanList{})},
...
// DeepCopy_servicecatalog_Plan is an autogenerated deepcopy function.
func DeepCopy_servicecatalog_Plan(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*Plan)
		out := out.(*Plan)
		*out = *in
...
// DeepCopy_servicecatalog_PlanList is an autogenerated deepcopy function.
func DeepCopy_servicecatalog_PlanList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*PlanList)
		out := out.(*PlanList)
		*out = *in
		if in.Items != nil {
			...
			*out = make([]Plan, len(*in))
			for i := range *in {
				if err := DeepCopy_servicecatalog_Plan(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
