...
func (x *ServiceClass) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[1] = x.APIVersion != ""
			yyq2[2] = true
			yyq2[9] = len(x.AlphaTags) != 0
			yyq2[10] = len(x.AlphaRequires) != 0
			var yynn2 int
			if yyr2 || yy2arr2 {
...
func (x *PlanList) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	if x == nil {
...
func (x *PlanList) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
...
func (x *PlanList) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yys3Slc = z.DecScratchBuffer() // default slice to decode into
...
func (x *PlanList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yyj12 int
...
func (x *Plan) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[1] = x.APIVersion != ""
			yyq2[2] = true
			yyq2[6] = x.Bindable != nil
			yyq2[9] = x.AlphaInstanceCreateParameterSchema != nil
			yyq2[10] = x.AlphaInstanceUpdateParameterSchema != nil
			yyq2[11] = x.AlphaBindingCreateParameterSchema != nil
			var yynn2 int
			if yyr2 || yy2arr2 {
...
func (x codecSelfer1234) encSlicePlan(v []Plan, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer1234) decSlicePlan(v *[]Plan, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == 0 {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, Plan{}) // var yyz1 Plan
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
