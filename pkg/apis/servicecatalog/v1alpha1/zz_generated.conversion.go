...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_Plan_To_servicecatalog_Plan,
		Convert_servicecatalog_Plan_To_v1alpha1_Plan,
		Convert_v1alpha1_PlanList_To_servicecatalog_PlanList,
		Convert_servicecatalog_PlanList_To_v1alpha1_PlanList,
...
func autoConvert_v1alpha1_Plan_To_servicecatalog_Plan(in *Plan, out *servicecatalog.Plan, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Name = in.Name
	out.ExternalID = in.ExternalID
...
// Convert_v1alpha1_Plan_To_servicecatalog_Plan is an autogenerated conversion function.
func Convert_v1alpha1_Plan_To_servicecatalog_Plan(in *Plan, out *servicecatalog.Plan, s conversion.Scope) error {
	return autoConvert_v1alpha1_Plan_To_servicecatalog_Plan(in, out, s)
}

func autoConvert_servicecatalog_Plan_To_v1alpha1_Plan(in *servicecatalog.Plan, out *Plan, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Name = in.Name
	out.ExternalID = in.ExternalID
	out.Description = in.Description
...
// Convert_servicecatalog_Plan_To_v1alpha1_Plan is an autogenerated conversion function.
func Convert_servicecatalog_Plan_To_v1alpha1_Plan(in *servicecatalog.Plan, out *Plan, s conversion.Scope) error {
	return autoConvert_servicecatalog_Plan_To_v1alpha1_Plan(in, out, s)
}

func autoConvert_v1alpha1_PlanList_To_servicecatalog_PlanList(in *PlanList, out *servicecatalog.PlanList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]servicecatalog.Plan)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_PlanList_To_servicecatalog_PlanList is an autogenerated conversion function.
func Convert_v1alpha1_PlanList_To_servicecatalog_PlanList(in *PlanList, out *servicecatalog.PlanList, s conversion.Scope) error {
	return autoConvert_v1alpha1_PlanList_To_servicecatalog_PlanList(in, out, s)
}

func autoConvert_servicecatalog_PlanList_To_v1alpha1_PlanList(in *servicecatalog.PlanList, out *PlanList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items == nil {
		out.Items = make([]Plan, 0)
	} else {
...
// Convert_servicecatalog_PlanList_To_v1alpha1_PlanList is an autogenerated conversion function.
func Convert_servicecatalog_PlanList_To_v1alpha1_PlanList(in *servicecatalog.PlanList, out *PlanList, s conversion.Scope) error {
	return autoConvert_servicecatalog_PlanList_To_v1alpha1_PlanList(in, out, s)
}
